...
Schema.prototype = {
    validateDocument: function validateDocument(document, rawData, callback) {
        ...
        this.fieldNames.forEach(function(name) {
            ...
            if ((field.required && !field.primaryKey) && !rawData[name]) {
    ...
    validateField: function validateField(document, fieldName, value) {
    ...
    transformedValueOfField: function transformedFieldValue(document, fieldName, value) {
        var field = this.fields[fieldName];
